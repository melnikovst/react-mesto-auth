      ...
      <div className="header__login-container">
        <p
          className={`header__email ${
            pathname !== '/' ? 'header__button_opened' : ''
          }`}
        >
          {email}
        </p>
