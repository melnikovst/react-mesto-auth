...
const Login: React.FC<{
  ...
  const onLogin: { email: string; password: string } = useMemo(() => {
    return {
      email: '',
      password: '',
    };
  ...
  const { values, handleChange, errors, isValid, setValues, handleBlur } =
      ...
      <div className="popup__container popup__container_type_auth">
        ...
        <form className="form form_type_auth">
          <fieldset className="fieldset">
            ...
            />
            <span
              className={`form__invalid-message email-error ${
            ...
            />
            <span
              className={`form__invalid-message password-error ${
                isValid ? '' : 'form__invalid-message_active'
              }`}
            >
              {errors.password}
